describe( 'Note', function(){
  ...
  describe( 'constructor', function() {
    ...
    it( 'should resolve duration names to ratios', function() {
      var whole = new Note('A4 w'),
          half = new Note('A4 h'),
          quarter = new Note('A4 q'),
          eighth = new Note('A4 e'),
          sixteenth = new Note('A4 s'),
          dottedEighth = new Note('A4 es');
    ...
    it( 'should parse duration literals', function() {
      var _int = new Note('A4 1'),
        _float = new Note('A4 0.5');
